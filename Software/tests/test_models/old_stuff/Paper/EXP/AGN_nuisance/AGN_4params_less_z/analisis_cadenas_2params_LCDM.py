...
with np.load('valores_medios_EXP_AGN_5params_nuisance_less_z.npz') as data:
    sol = data['sol']
#%%
os.chdir(path_datos_global+'/Resultados_cadenas')
filename = "sample_EXP_AGN_5params_nuisance_less_z.h5"
...
#%%
mcmc = np.percentile(gammas, [5, 50, 95]) #Hay coincidencia a 2 sigma :/ (x 0.001!)
q = np.diff(mcmc)
txt = "\mathrm{{{3}}} = {0:.3f}_{{-{1:.3f}}}^{{+{2:.3f}}}"
