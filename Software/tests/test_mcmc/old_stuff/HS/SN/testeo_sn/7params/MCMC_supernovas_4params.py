...
from data import leer_data_pantheon, leer_data_cronometros
from cron_SN import params_to_chi2
...
def log_prior(theta):
    ...
    if (-22 < M < -18 and  0.01 < omega_m < 0.5 and
        0 < b < 2 and 60 < H0 < 80 and 60 < alpha < 80 and 60 < beta < 80 and
        60 < gamma < 80 ):
        return 0.0
    return -np.inf
