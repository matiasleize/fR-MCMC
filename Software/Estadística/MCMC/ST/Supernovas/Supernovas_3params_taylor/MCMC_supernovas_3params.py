...
with np.load('valores_medios_ST_supernovas_3params_taylor.npz') as data:
    sol = data['sol']
print(sol)
...
log_likelihood = lambda theta: -0.5 * params_to_chi2_taylor(ci, theta,
                                [H0_true,n], zcmb, zhel, Cinv, mb,model='ST')
...
filename = "sample_ST_supernovas_3params_taylor.h5"
