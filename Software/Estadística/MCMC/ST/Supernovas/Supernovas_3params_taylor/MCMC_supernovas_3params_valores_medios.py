...
nll = lambda theta: params_to_chi2_taylor(ci, theta, params_fijos, zcmb, zhel, Cinv, mb,model='ST')
...
np.savez('valores_medios_ST_supernovas_3params_taylor', sol=soln.x)
