...
#%%
np.random.seed(42)
nll = lambda theta: params_to_chi2(ci, theta, n, zcmb, zhel, Cinv, mb,model='ST')
initial = np.array([M_true,omega_m_true,b_true,H0_true])
bnds =((-20,-18),(0.01,0.4),(-5, 5),(60,80))
...
np.savez('valores_medio_ST_supernovas_4params', sol=soln.x)
