...
with np.load('valores_medios_ST_supernovas_3params.npz') as data:
    sol = data['sol']
print(sol)
sol[1] = 0.23
sol[2] = 0
...
log_likelihood = lambda theta: -0.5 * params_to_chi2(ci, theta, [H0_true,n], zcmb, zhel, Cinv, mb,model='ST')
...
filename = "sample_ST_supernovas_3params.h5"
