...
with np.load('valores_medios_ST_cron+SN+BAO_3params_taylor.npz') as data:
    sol = data['sol']
print(sol)
...
log_likelihood = lambda theta: -0.5 * params_to_chi2_taylor(theta,params_fijos,
                                zcmb, zhel, Cinv,mb,z_data, H_data, dH, dataset,model='ST')
...
filename = "sample_ST_cron+SN+BAO_3params_taylor.h5"
