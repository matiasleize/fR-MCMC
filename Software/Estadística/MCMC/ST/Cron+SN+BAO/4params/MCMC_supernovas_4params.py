...
with np.load('valores_medios_ST_CC+SN+BAO_4params.npz') as data:
    sol = data['sol']
print(sol)
...
for sample in sampler.sample(pos, iterations=max_n, progress=True):
    ...
    if converged:
        textfile_witness = open('witness_6.txt','a')
