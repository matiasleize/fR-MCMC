...
log_likelihood = lambda theta: -0.5 * params_to_chi2_taylor(theta,n,z_data,H_data,dH,model='ST')
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
with np.load('valores_medios_ST_cronom_3params_taylor.npz') as data:
    sol = data['sol']
#%%
def log_prior(theta):
    omega_m, b, H_0 = theta
...
#filename = "sample_ST_cronom_3params_taylor_prior_om_agrandado.h5"
filename = "sample_ST_cronom_3params_taylor.h5"
