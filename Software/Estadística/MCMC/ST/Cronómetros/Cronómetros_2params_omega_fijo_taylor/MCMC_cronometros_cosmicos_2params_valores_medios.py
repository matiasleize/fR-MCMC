...
nll = lambda theta: params_to_chi2_taylor(theta,[omega_m_true,n],
                    z_data,H_data,dH,omega_fijo=True,model='ST')
...
np.savez('valores_medios_ST_cronom_2params_omega_fijo_taylor', sol=soln.x)
