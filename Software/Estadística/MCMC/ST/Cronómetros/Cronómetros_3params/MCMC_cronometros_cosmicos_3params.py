...
log_likelihood = lambda theta: -0.5 * params_to_chi2(ci,theta,n,z_data,H_data,dH,model='ST')
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
with np.load('valores_medios_ST_cronom_3params.npz') as data:
    sol = data['sol']
np.min(z_data)
sol[1] = 0
print(sol)
...
filename = "sample_ST_cronom_3params.h5"
