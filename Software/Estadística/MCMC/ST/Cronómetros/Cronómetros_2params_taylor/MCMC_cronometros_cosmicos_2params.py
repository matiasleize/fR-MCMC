...
log_likelihood = lambda theta: -0.5 * params_to_chi2_taylor(theta,[H_0,n],z_data,H_data,dH,model='ST')
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
with np.load('valores_medios_ST_cronom_2params_taylor.npz') as data:
    sol = data['sol']
print(sol)
#%%
def log_prior(theta):
...
filename = "sample_ST_cronom_2params_taylor.h5"
