...
with np.load('valores_medios_LCDM_CC+SN+H0_4params.npz') as data:
    sol = data['sol']

#%% Importo las cadenas
os.chdir(path_datos_global+'/Resultados_cadenas')
filename = "sample_LCDM_CC+SN+H0_4params.h5"
...
#thin=5
%matplotlib qt5
analisis = Graficador(reader, ['$M_{abs}$','$\Omega_{m}$','$H_{0}$'],'CC+SN+H0 (LCDM)')
