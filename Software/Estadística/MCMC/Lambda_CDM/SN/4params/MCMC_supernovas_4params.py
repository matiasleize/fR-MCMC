...
with np.load('valores_medios_LCDM_SN_4params.npz') as data:
    sol = data['sol']
print(sol)
...
pos = sol + 1e-4 * np.random.randn(15, 4) #Defino la cantidad de caminantes.
nwalkers, ndim = pos.shape

#%%
# Set up the backend
os.chdir(path_datos_global+'/Resultados_cadenas/')
filename = "sample_LCDM_SN_4params.h5"
