...
soln = minimize(nll, initial, options = {'eps': 0.01},
                bounds =((-20,-18.5),(0.15,0.165),(2.95, 3.09),(0.047,0.065)))
M_ml,alpha_ml,beta_ml,gamma_ml = soln.x

print(M_ml,alpha_ml,beta_ml,gamma_ml)

os.chdir(path_git + '/Software/Estadística/Resultados_simulaciones')
np.savez('valores_medios_LCDM_SN_4params', sol=soln.x)
#%%
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
