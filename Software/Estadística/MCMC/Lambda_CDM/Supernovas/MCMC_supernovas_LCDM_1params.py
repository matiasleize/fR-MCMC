...
log_likelihood = lambda theta: -0.5 * params_to_chi2(theta, [M_true,H0_true], zcmb,
...
pos = sol + 1e-4 * np.random.randn(120, 1) #Defino la cantidad de caminantes.
