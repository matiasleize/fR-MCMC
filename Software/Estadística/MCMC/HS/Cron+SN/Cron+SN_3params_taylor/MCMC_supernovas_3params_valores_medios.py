...
nll = lambda theta: params_to_chi2_taylor(theta,params_fijos,zcmb, zhel, Cinv,mb,z_data, H_data, dH)
...
np.savez('valores_medios_HS_cron+SN_3params_taylor', sol=soln.x)
