...
#with np.load('valores_medios_HS_cron+SN_3params_M_fijo_taylor.npz') as data:
with np.load('valores_medios_HS_cron+SN_3params_M_fijo_sin_riess_taylor.npz') as data:
    sol = data['sol']
#%%
os.chdir(path_datos_global+'/Resultados_cadenas')
filename = "sample_HS_cron+SN_3params_M_fijo_taylor.h5"
