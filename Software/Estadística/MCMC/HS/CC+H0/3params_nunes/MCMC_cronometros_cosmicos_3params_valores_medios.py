...
nll = lambda theta: params_to_chi2(theta,n,z_data,H_data,dH,H0_nunes=True)
initial = np.array([omega_m_true,b_true,H0_true])
bnds = ((0.05, 0.5), (0,4), (60,80))
...
np.savez('valores_medios_HS_CC+H0_3params_nunes', sol=soln.x)
