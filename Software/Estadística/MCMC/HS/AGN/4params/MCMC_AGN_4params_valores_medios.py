...
initial = np.array([omega_m_true,b_true,H0_true,l_true])
soln = minimize(nll, initial, options = {'eps': 0.01},
                bounds =((0.1,0.7),(0,0.5),(60,80),(1,30)))
omega_m_ml,b_ml,H0_ml,l_ml = soln.x

print(omega_m_ml,b_ml,H0_ml,l_ml)

os.chdir(path_git + '/Software/Estadística/Resultados_simulaciones')
np.savez('valores_medios_HS_AGN_4params', sol=soln.x)
soln.fun / (len(Theta_data)-4)
#%%
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
