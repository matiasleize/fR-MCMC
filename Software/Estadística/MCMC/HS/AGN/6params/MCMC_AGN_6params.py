...
def log_prior(theta):
    omega_m, b, H0, l, beta, n_agn = theta
    if (0.1 < omega_m < 0.5 and 0 < b < 0.6 and 60 < H0 < 80
        and 1 < l < 30 and -0.1 < beta < 0.1 and -0.1 < n_agn < 0.1):
        return 0.0
    return -np.inf
...
filename = "sample_HS_AGN_6params.h5"
