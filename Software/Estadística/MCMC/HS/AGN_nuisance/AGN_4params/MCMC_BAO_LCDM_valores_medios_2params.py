...
nll = lambda theta: params_to_chi2_AGN_nuisance(theta, [H0_true,1], data_agn)
initial = np.array([omega_m_true,b_true,beta_true,gamma_true,delta_true])
bnds = ((0.85,1.0),(0,0.2),(6.5,7.5),(0.5,0.8),(0.1,0.3))
...
np.savez('valores_medios_HS_AGN_5params_nuisance', sol=soln.x)
