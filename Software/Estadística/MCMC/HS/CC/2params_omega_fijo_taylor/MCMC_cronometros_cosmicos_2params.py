...
log_likelihood = lambda theta: -0.5 * params_to_chi2_taylor(theta,[omega_m,n],
                z_data,H_data,dH,omega_fijo=True,chi_riess=False)
os.chdir(path_git+'/Software/Estadística/Resultados_simulaciones/')
with np.load('valores_medios_HS_CC_2params_omega_fijo_taylor.npz') as data:
    sol = data['sol']
print(sol)
#%%
def log_prior(theta):
...
filename = "sample_HS_CC_2params_omega_fijo_taylor.h5"
