...
soln = minimize(nll, initial, options = {'eps': 0.01}, bounds =((-25,-18),(0.1,0.5),(64,72)))
...
np.savez('valores_medios_LCDM_CC+SN_3params', sol=soln.x)

num_data_CC = len(ds_CC[0])
num_data_SN = len(ds_SN[0])
datos_totales = num_data_CC+num_data_SN

soln.fun/(datos_totales-len(soln.x)) #0.9700160395936941
