...
#    sol_1 = solve_ivp(sistema_ec, (z_inicial,zf),
...
sol_1.y[0]
sol.y[0]
#Para comparar mejor, faltaría interpolar, pero todo parece indicar que da lo mismo
#Lo que es turvio el el len(sol_1)=32!!
