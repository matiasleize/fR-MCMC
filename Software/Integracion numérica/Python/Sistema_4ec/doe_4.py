...
# Guardamos z y v(z)
np.savez('/home/matias/Documents/Tesis/Software/Integracion numérica/Python/Sistema_4ec/v(z)'
         , zs=sol.t, v=sol.y[2])
...
# Guardamos z y H()
np.savez('/home/matias/Documents/Tesis/Software/Integracion numérica/Python/Sistema_4ec/H(z)'
